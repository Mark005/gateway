...
@Service
public class PatchRemoveAuthorityGroupsFromUser extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/users/{userId}/authority-group/remove");
  }

  @Override
  public String getTargetRouting() {
    return "/users/{userId}/authority-group/remove";
  }
