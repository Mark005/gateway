...
@Service
public class PatchChangeContactPhoneForOrdersDelivery extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/users/current/orders/{orderId}/delivery/contact-phone");
  }

  @Override
  public String getTargetRouting() {
    return "/users/current/orders/{orderId}/delivery/contact-phone";
  }
