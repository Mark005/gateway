package com.bmo.common.gateway.core.route.services.market.payment_details;
...
@Service
public class GetCurrentUsersPaymentDetailsByOrderId extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/users/current/orders/{id}/payment-details");
  }

  @Override
  public String getTargetRouting() {
    return "/users/current/orders/{id}/payment-details";
  }
