...
@Service
public class PatchRemoveAuthoritiesFromUser extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/users/{userId}/authorities/remove");
  }

  @Override
  public String getTargetRouting() {
    return "/users/{userId}/authorities/remove";
  }
