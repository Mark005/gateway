...
@Service
public class GetAllProductItemByProductId extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/product/{id}/product-items");
  }

  @Override
  public String getTargetRouting() {
    return "/product/{id}/product-items";
  }

  @Override
  public Set<AuthorityEnum> getRequiredAuthorities() {
    return Set.of(AuthorityEnum.PRODUCT_ITEM_READ);
  }
}
