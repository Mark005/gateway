...
@Service
public class PatchChangeAddressForOrdersDelivery extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/users/current/orders/{orderId}/delivery/delivery-address");
  }

  @Override
  public String getTargetRouting() {
    return "/users/current/orders/{orderId}/delivery/delivery-address";
  }
