...
@Service
public class PatchChangeDeliveryTypeForOrdersDelivery extends AbstractSecurityGatewayRoute {
  ...
  public List<String> getPathPatterns() {
    return List.of("/users/current/orders/{orderId}/delivery/delivery-type");
  }

  @Override
  public String getTargetRouting() {
    return "/users/current/orders/{orderId}/delivery/delivery-type";
  }
